...
git clone https://github.com/huangtiancai/h5-template.git
...
关于适配的问题,因为我们使用的是 Vant UI，所以必须根据 Vant UI 375 的设计规范走，一般我们的设计会将 UI 图上
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      doDispatch() {
        this.$store.dispatch('setUserName', '嘿嘿😁')
      }
    }
  }
</script>
